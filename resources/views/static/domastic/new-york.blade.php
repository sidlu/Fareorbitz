...
<section class="page-banner">
    <img src="{{ url('/images/flights/new-york.jpg') }}" class="lazyload img-fluid" alt="New York" />
</section>
    ...
    <div class="mb-0 mt-3">
        <div class="sidebar-widget">
            <div class="section-heading pt-3">
                <h2 class="sec__title text-left">Looking to Book Flights to New York?</h2>
            </div>
        </div>
        <div class="sidebar-widget">
            <blockquote>
                ...
                <p>They say everyone should live in New York City at least once in their lifetime. New York is majorly known for its diverse cuisine, best museums, high-end fashion and culture in the world.</p>
            </blockquote>
